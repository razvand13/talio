...
public class ListContainer extends VBox {
    ...
    private ListOfCards listOfTasks;
    ...
    public void setAddTaskAction(Button button, TextField textField, ListView<String> list) {
        button.setOnAction(event -> {
            ...
            if (!taskInput.equals("")) {
                ...
                listOfTasks.cards.add(new Card(taskInput,null,null,listOfTasks));
                textField.clear();
            }
    ...
    public void setSaveEditAction(Button editBtn, Button delBtn, TextField textField,
        ...
        editBtn.setOnAction(event -> {
            ...
            if (idx != -1 && edit.length() >= 1) {
                ...
                Card copy = listOfTasks.cards.get(idx);
                copy.title = edit;
                listOfTasks.cards.set(idx,copy);
                editBtn.setVisible(false);
    ...
    public void setDragAndDrop(ListView<String> list) {
        ...
        list.setOnDragDone(event -> dragDone(list, event,listOfTasks));
    ...
    private void dragDropped(ListView<String> list, DragEvent event) {
        ...
        if (db.hasString()) {
            ...
            listOfTasks.cards.add(new Card(dbContent,null,null,listOfTasks));
            success = true;
        }
     ...
     */
    private void dragDone(ListView<String> list, DragEvent event, ListOfCards listOfTasks) {
        String selectedItem = list.getSelectionModel().getSelectedItem();
